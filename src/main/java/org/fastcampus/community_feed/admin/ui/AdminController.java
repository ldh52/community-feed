...
public class AdminController {
    ...
    public ModelAndView index() {
        ...
        List<GetDailyRegisterUserResponseDto> result = userStatsQueryRepository.getDailyRegisterUserStats(
            7);
    ...
    public ModelAndView users(GetUserTableRequestDto dto) {
        ...
        GetTableListResponseDto<GetUserTableResponseDto> result = userTableQueryRepository.getUserTable(
            dto);
    ...
    public ModelAndView posts(GetPostTableRequestDto dto) {
        ...
        GetTableListResponseDto<GetPostTableResponseDto> result = userTableQueryRepository.getPostTable(
            dto);
        modelAndView.addObject("requestDto", dto);
